...
public class MainActivity extends BaseActivity {
	...
	private MyMusicListFragment musicListFragment;
...
//		ini(this, dbUtils);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.like:
			Intent intent1 = new Intent(this,MyLikeMusicListActivity.class);
...
//			return true;
			break;
		case R.id.exit:
//			Intent intent2 = new Intent(this,PlayRecordListActivity.class);
//			startActivity(intent2);
		...
		public Fragment getItem(int position) {
			if(position ==0){
				if(musicListFragment ==null){
					musicListFragment = MyMusicListFragment.newInstance();
				}
	...
	public void change(int position) {
		if(pager.getCurrentItem()==0){
		   ...
		   musicListFragment.changeUIStatusOnPlay(position);
